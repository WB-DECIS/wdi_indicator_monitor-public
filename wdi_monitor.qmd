...
```{r}
# This single code chunk is one column occupying the entire row.
...
# med_latest_year <- 2018
 ...
 # ====================== Tile 1: Country Coverage ======================
  htmltools::div(
    ...
    ",
    # Centered header
    htmltools::h3("Country coverage", style="text-align: center; margin-top: 0;"),
    ...
    htmltools::tags$table(
      ...
      htmltools::tags$tr(
        htmltools::tags$td("Total number of economies:", style="padding: 5px;"),
        htmltools::tags$td(n_countries,       style="padding: 5px; text-align: right;")
      ),
      # Row 2: "Median economies per ind." + med_n_country
      htmltools::tags$tr(
        htmltools::tags$td("Median economies per indicator:", style="padding: 5px;"),
        htmltools::tags$td(med_n_country,                 style="padding: 5px; text-align: right;")
      ),
      # Row 3: "Median % of LMICs" + med_p_lmics
      htmltools::tags$tr(
        htmltools::tags$td("Median % of LMICs per indicator:", style="padding: 5px;"),
        htmltools::tags$td(med_p_lmics,          style="padding: 5px; text-align: right;")
      )
    )
  )
```
 ...
 # ====================== Tile 2: Time Coverage ======================
  htmltools::div(
    ...
    htmltools::tags$table(
      ...
      htmltools::tags$tr(
        htmltools::tags$td("Total number of years:", style="padding: 5px;"),
        htmltools::tags$td(n_years,                    style="padding: 5px; text-align: right;")
      ),
      # Row 2: "Median year span" + med_yr_span
      htmltools::tags$tr(
        htmltools::tags$td("Median year span per indicator:", style="padding: 5px;"),
        htmltools::tags$td(med_yr_span,         style="padding: 5px; text-align: right;")
      ),
      # Row 3: "Median latest year" + med_latest_year
      htmltools::tags$tr(
        htmltools::tags$td("Median latest year per indicator:", style="padding: 5px;"),
        htmltools::tags$td(med_latest_year,       style="padding: 5px; text-align: right;")
      )
    )
  )
```
